...
dot product $= 0\implies \theta = \frac{\pi}{2}$ angolo retto (orthogonal)
...
[[👁️]] The cross product returns $\vec{0}$ (null vector) when the two operands are [[#Linear Combination|Linearly dependent]].
...
$$
\theta = \tan^{-1} \frac{\vec{a}_{x}}{\vec{a}_{y}}
$$

...
### REFAC:  Triple Product

(a cross b) dot c = norm(a cross b) cdot norm(c) cdot cos alpha

norm(c) cdot cos alpha => projection of c onto a cross b

#### In Vectorial Geometry

used to get the volume of the parallelepiped defined by the three vectors

are this three vectors LI? -> triple product = 0 => NO, triple product != 0 => YES

if triple prod result > 0 -> terna destrorsa (c destrorso ad a e b)
" < 0 -> terna sinistrorsa

find H, projection of P in plane A,B,C (R^3)
H = P + PH
